...
require 'omniauth/strava/signed_request'
require 'openssl'
require 'rack/utils'
require 'uri'
...
module OmniAuth
  module Strategies
    class Strava < OmniAuth::Strategies::OAuth2
      ...
      DEFAULT_SCOPE = 'read,read_all,profile:read_all,activity:read,activity:read_all'
      ...
      rescue OmniAuth::Strava::SignedRequest::UnknownSignatureAlgorithmError => e
      ...
      #      https://github.com/Strava/Strava-php-sdk/blob/master/src/base_Strava.php#L477
      def callback_url
      ...
      #
      # For example: /auth/Strava?display=popup
      ...
      def signed_request_from_cookie
        @signed_request_from_cookie ||= raw_signed_request_from_cookie && OmniAuth::Strava::SignedRequest.parse(raw_signed_request_from_cookie, client.secret)
      end
